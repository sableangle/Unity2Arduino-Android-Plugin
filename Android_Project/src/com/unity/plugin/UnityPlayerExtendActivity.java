...
public class UnityPlayerExtendActivity extends UnityPlayerActivity {
	...
	public void CallToast(final String a){
		runOnUiThread(new Runnable() { @Override public void run() { Toast.makeText(mContext, a, Toast.LENGTH_SHORT).show(); } });
	}
	
	public void OpenScanPanel(String type){
    ...
    private void connectDevice(Intent data) {
        ...
        try{
            ...
            String uuidString = data.getExtras()
                    .getString("Bluetooth Mode");
            UUID MY_UUID;
            if(uuidString == ""){
            	//Default is Secure Connect
            ...
            mChatService.connect(device, MY_UUID);
            
            CallToast("Try finish!");
